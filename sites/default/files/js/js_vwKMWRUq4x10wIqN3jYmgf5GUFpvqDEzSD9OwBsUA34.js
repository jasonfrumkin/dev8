...
jQuery(".toolbar-icon-help").click(function(){
    setTimeout(function(){
      jQuery(".conbuttons").show();
        ...
        jQuery(".registrations-no").click(function(){
            setTimeout(function(){
                jQuery(".joyride-next-tip").eq(1).trigger("click");
            }, 300);
        })
        ...
        jQuery(".event-no").click(function(){
            setTimeout(function(){
                jQuery(".joyride-next-tip").eq(2).trigger("click");
            }, 300);
        })
        jQuery(".calendar-yes").click(function(){
          var calgen = "Yes";
            setTimeout(function(){
                jQuery(".joyride-next-tip").eq(3).trigger("click");
                if(document.getElementById('edit-rng-status-value').checked) {
                    var regen = "Yes";
                } else {
                    var regen = "No";
                }
                if(document.getElementById('edit-field-is-reservation-event-value').checked) {
                    var engen = "Yes";
                } else {
                    var engen = "No";
                }
                jQuery(".double-check").html("<br/><br/><p>Registrations Enabled: "+regen+"</p><p>Is Event: "+engen+"</p><p>Show on Calendar: "+calgen+"</p>");
        ...
        jQuery(".calendar-no").click(function(){
          var calgen = "No";
            setTimeout(function(){
                ...
                jQuery(".double-check").html("<br/><br/><p>Registrations Enabled: "+regen+"</p><br/><br/><p>Is Event: "+engen+"</p><br/><br/><p>Show on Calendar: "+calgen+"</p>");
