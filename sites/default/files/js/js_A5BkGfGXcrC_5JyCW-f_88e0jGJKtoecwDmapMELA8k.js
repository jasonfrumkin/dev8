...
for (var viewName in settings.views.ajaxViews) {
  ...
  //if (settings.views.ajaxViews[viewName].view_display_id == 'myview_display') {
    ...
    viewSettings.view_args = itinerary_date + '/' + itinerary_category;

    // Apply to views settings.
    Drupal.settings.views.ajaxViews['views_dom_id:' + dom_id] = viewSettings;
