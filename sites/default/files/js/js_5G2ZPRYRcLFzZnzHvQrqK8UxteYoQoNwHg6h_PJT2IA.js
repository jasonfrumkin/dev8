        ...
        jQuery(".calendar-yes").click(function(){
          var calgen = "Yes";
            ...
            setTimeout(function(){
                ...
                jQuery(".double-check").html("<br/><br/><p>Registrations Enabled: "+regen+"</p>");
                jQuery(".double-check").html("<br/><br/><p>Is Event: "+engen+"</p>");
                jQuery(".double-check").html("<br/><br/><p>Show on Calendar: "+calgen+"</p>");
